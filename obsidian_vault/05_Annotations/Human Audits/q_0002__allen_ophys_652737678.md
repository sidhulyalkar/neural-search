---
annotation_id: q_0002__allen_ophys_652737678
audit_status: pending
confidence: 0.95
created: '2026-06-17'
dataset_id: allen:ophys_652737678
judge_version: lf_v1
label: 0
query_id: q_0002
source: bronze
...
## Dataset
**Allen Brain Observatory: Fezf2-CreER 2P calcium imaging — three_session_A in Lateral visual area at 375μm depth**

Allen Brain Observatory two-photon calcium imaging session. Mouse line: Fezf2-CreER. Genotype: Fezf2-CreER/wt;Ai148(TIT2L-GC6f-ICL-tTA2)/wt. Brain region: Lateral visual area (VISl). Imaging depth: 375μm. Stimulus protocol: three_session_A. Data available in NWB format via AllenSDK.
