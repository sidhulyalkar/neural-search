---
annotation_id: q_0002__allen_ophys_508378520
audit_status: pending
confidence: 0.95
created: '2026-06-17'
dataset_id: allen:ophys_508378520
judge_version: lf_v1
label: 0
query_id: q_0002
source: bronze
...
## Dataset
**Allen Brain Observatory: Rbp4-Cre 2P calcium imaging — three_session_B in posteromedial visual area at 375μm depth**

Allen Brain Observatory two-photon calcium imaging session. Mouse line: Rbp4-Cre. Genotype: Rbp4-Cre_KL100/wt;Camk2a-tTA/wt;Ai93(TITL-GCaMP6f)/wt. Brain region: posteromedial visual area (VISpm). Imaging depth: 375μm. Stimulus protocol: three_session_B. Data available in NWB format via AllenSDK.
