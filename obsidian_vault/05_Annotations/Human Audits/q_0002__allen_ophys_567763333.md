---
annotation_id: q_0002__allen_ophys_567763333
audit_status: pending
confidence: 0.95
created: '2026-06-17'
dataset_id: allen:ophys_567763333
judge_version: lf_v1
label: 0
query_id: q_0002
source: bronze
...
## Dataset
**Allen Brain Observatory: Cux2-CreERT2 2P calcium imaging — three_session_B in Lateral visual area at 275μm depth**

Allen Brain Observatory two-photon calcium imaging session. Mouse line: Cux2-CreERT2. Genotype: Cux2-CreERT2/wt;Camk2a-tTA/wt;Ai93(TITL-GCaMP6f)/wt. Brain region: Lateral visual area (VISl). Imaging depth: 275μm. Stimulus protocol: three_session_B. Data available in NWB format via AllenSDK.
