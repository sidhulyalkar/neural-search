---
annotation_id: q_0002__allen_ophys_568753147
audit_status: pending
confidence: 0.95
created: '2026-06-17'
dataset_id: allen:ophys_568753147
judge_version: lf_v1
label: 0
query_id: q_0002
source: bronze
...
## Dataset
**Allen Brain Observatory: Nr5a1-Cre 2P calcium imaging — three_session_B in Anteromedial visual area at 320μm depth**

Allen Brain Observatory two-photon calcium imaging session. Mouse line: Nr5a1-Cre. Genotype: Nr5a1-Cre/wt;Camk2a-tTA/wt;Ai93(TITL-GCaMP6f)/wt. Brain region: Anteromedial visual area (VISam). Imaging depth: 320μm. Stimulus protocol: three_session_B. Data available in NWB format via AllenSDK.
