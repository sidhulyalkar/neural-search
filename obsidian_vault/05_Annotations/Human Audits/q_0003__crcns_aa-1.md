---
annotation_id: q_0003__crcns_aa-1
audit_status: pending
confidence: 0.95
created: '2026-06-17'
dataset_id: crcns:aa-1
judge_version: lf_v1
label: 0
query_id: q_0003
source: bronze
...
## Dataset
**aa-1: Single-unit recordings from two auditory areas in male zebra finches (Frederic Theunissen lab, UC Berkeley)**

Single-unit recordings from two auditory areas in male zebra finches (Frederic Theunissen lab, UC Berkeley).
