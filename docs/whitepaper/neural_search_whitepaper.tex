...
Ablation results demonstrate that each signal contributes measurable value:
\begin{itemize}
...
\subsection{Latent Neural Signature Search}

Move from metadata summaries to extracted neural population features:
\begin{equation}
    \text{latent}(d) = \text{Extractor}(\text{NWB/BIDS}(d))
\end{equation}
