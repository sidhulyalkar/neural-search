...
_IBL_PROJECTS: list[dict[str, Any]] = [
    {
        ...
        "modalities": ["extracellular_electrophysiology", "neuropixels", "behavior"],
        "brain_regions": ["frontal_cortex", "parietal_cortex", "hippocampus", "thalamus", "striatum", "hindbrain"],
    ...
    },
    {
        ...
        "modalities": ["extracellular_electrophysiology", "neuropixels", "behavior"],
        "brain_regions": ["frontal_cortex", "parietal_cortex", "hippocampus", "thalamus", "striatum", "hindbrain", "whole_brain"],
        "tasks": ["decision_making", "two_alternative_forced_choice"],
    ...
    },
    {
        ...
        "modalities": ["extracellular_electrophysiology", "neuropixels", "calcium_imaging", "fiber_photometry", "behavior"],
        "brain_regions": ["frontal_cortex", "parietal_cortex", "hippocampus", "thalamus", "striatum", "hindbrain", "whole_brain"],
    ...
    },
    {
        ...
        "s3_prefix": None,
        "modalities": ["extracellular_electrophysiology", "neuropixels", "lfp", "behavior"],
...
def _normalize_session_row(row: Any, session_uuid: str) -> dict[str, Any]:
    ...
    return {
        ...
        "species": ["mouse"],
        "modalities": (
            ["extracellular_electrophysiology", "neuropixels", "behavior"]
