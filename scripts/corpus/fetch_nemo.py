"""Fetch NeMO Archive BRAIN Initiative datasets and append to corpus.

Usage:
    python scripts/corpus/fetch_nemo.py [--dry-run] [--limit N]
"""
...
logger = logging.getLogger("nemo_fetch")
...
def main(argv=None):
    ...
    logger.info("Fetched %d NeMO records", len(records))
